    ...
    public void onMessage(Message message, Session session) throws JMSException {
        ...
        try {
            if (message instanceof MapMessage) {
                ...
                Properties props = PropertiesUtil.getProperties("/syncdata.properties");
                            ...
                            if (changeStateRefTeacherList != null) {
                                for (ChangeStateRefTeacher changeStateRefTeacher : changeStateRefTeacherList) {
                                    ...
                                    if (count > 0) {
                                        ...
                                        changeStateRefTeacherExample.createCriteria().andSyncClassIdEqualTo(changeStateRefTeacher.getSyncClassId()).andSyncTeacherIdEqualTo(changeStateRefTeacher.getSyncTeacherId());
